...
export default function WhatsAppFAB() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-green-300/50 hover:shadow-xl hover:shadow-green-400/60 hover:scale-110 animate-pulse-ring transition-transform duration-200"
    >
